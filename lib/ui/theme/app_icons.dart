...
class AppIcon {
  ...
  static const IconData upcoming = IconData(0xf026, fontFamily: _kFontFam);
  static const IconData dot = IconData(0xf032, fontFamily: _kFontFam);
  static const IconData professional = IconData(0xf204, fontFamily: _kFontFam);
  static const IconData atom = IconData(0xf409, fontFamily: _kFontFam);
  static const IconData organizer = IconData(0xf203, fontFamily: _kFontFam);
  static const IconData world = IconData(0xf089, fontFamily: _kFontFam);
  static const IconData aialert = IconData(0xf215, fontFamily: _kFontFam);
  static const IconData aiChecked = IconData(0xf217, fontFamily: _kFontFam);
}
