...
class AppColor {
  ...
  static const Color unselectedWidgetColor = Color(0xFF757575);

  // Add dark theme colors
  static const Color dark = Color(0xFF000000);
  static const Color darkPrimary = Color(0xff0c3249);
  static const Color darkSecondary = Color(0xFF1C1C1C);
  static const Color darkAppBar = Color(0xFF000000);
  static const Color darkCard = Color(0xFF1C1C1C);
  static const Color darkDivider = Color(0xFF2D3436);
  static const Color darkCardColor = Color(0xff000000);
  static const Color darkUnselectedWidgetColor = Color(0xFF757575);
}
