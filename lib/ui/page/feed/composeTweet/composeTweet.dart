...
import 'package:Trusty/ui/page/feed/composeTweet/widget/composeBottomIconWidget.dart';
import 'package:Trusty/ui/page/feed/composeTweet/widget/composeTweetImage.dart';
import 'package:Trusty/ui/page/feed/composeTweet/widget/widgetView.dart';
...
class _ComposeTweetReplyPageState extends State<ComposeTweetPage> {
  ...
  void _handleTextChange() {
    ...
    // Only check for URLs if the text ends with a space or newline
    ...
    if (matches.isNotEmpty) {
      String url = matches.last.group(0)!;
      // Validate URL has at least one dot and no spaces
    ...
    // Only update state if URL has changed and is valid
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          if (viewState._currentUrl != null)
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 8),
              child: LinkPreviewer(url: viewState._currentUrl),
            ),
          Flexible(
            child: Stack(
              children: <Widget>[
